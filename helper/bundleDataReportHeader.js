...
const identitasPengirim = (req, res, next) => {
  try {
    ...
    Decrypt.identitasPengirim.tanggalIjinBpkPengirim = convertStrignToDateUTC(
      Decrypt.identitasPengirim.tanggalIjinBpkPengirim
    );
...
const dataPerkiraanTanggalPengeluaran = (req, res, next) => {
  try {
    ...
    Decrypt.dataPerkiraanTanggalPengeluaran.perkiraanTanggalPengeluaran =
    ...
    req.body.DataToInput = {
      ...
      dataPerkiraanTanggalPengeluaran:
        dataToInputDataPerkiraanTanggalPengeluaran,
    };
