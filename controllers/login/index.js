...
const loginBeaCukai = async(req, res) => {
    const validation = validationResult(req);
    if(!validation.isEmpty()){
        return errorResponse(res, Http.badRequest, validation.array()[0].msg);
    }
...
module.exports = routes => {
    ...
    routes.post('/bc', bundleLogin, validationLogin, loginBeaCukai);
    routes.post('/admin', bundleLogin, validationLogin, loginAdmin);
}
